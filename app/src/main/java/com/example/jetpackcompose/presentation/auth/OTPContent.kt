...
import com.example.jetpackcompose.presentation.auth.SendOtpViewModel
import com.example.jetpackcompose.presentation.auth.VerifyOtpViewModel
...
fun OTPContent(navController: NavHostController, email: String) {
    ...
    val sendOtpViewModel: SendOtpViewModel = hiltViewModel<SendOtpViewModel>()
    val verifyOTP: VerifyOtpViewModel = hiltViewModel<VerifyOtpViewModel>()

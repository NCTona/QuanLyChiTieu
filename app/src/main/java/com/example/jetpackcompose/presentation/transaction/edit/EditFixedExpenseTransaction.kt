...
import com.example.jetpackcompose.presentation.transaction.fixed.GetFixedTransactionViewModel
import com.example.jetpackcompose.presentation.transaction.fixed.PutFixedTransactionViewModel
import com.example.jetpackcompose.data.remote.dto.RepeatFrequency
...
fun EditFixedExpenseTransaction(
    ...
    val getFixedTransactionViewModel: GetFixedTransactionViewModel =
        hiltViewModel<GetFixedTransactionViewModel>()
    val putFixedTransactionViewModel: PutFixedTransactionViewModel =
        hiltViewModel<PutFixedTransactionViewModel>()

package com.example.jetpackcompose.presentation.transaction.input
...
import com.example.jetpackcompose.presentation.budget.GetLimitTransactionViewModel
...
@Composable
fun ExpenseContent(
    postViewModel: PostTransactionViewModel = hiltViewModel<PostTransactionViewModel>(),
    getRemainLimit: GetLimitTransactionViewModel = hiltViewModel<GetLimitTransactionViewModel>()
) {

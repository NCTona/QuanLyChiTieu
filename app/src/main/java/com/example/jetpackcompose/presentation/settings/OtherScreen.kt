package com.example.jetpackcompose.presentation.settings
...
import com.example.jetpackcompose.presentation.auth.LogOutViewModel
...
fun OtherScreen(navController: NavHostController) {
    ...
    val logOutViewModel: LogOutViewModel = hiltViewModel<LogOutViewModel>()
